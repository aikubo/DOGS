 ...
 */
template <bool is_ad>
class PorousFlowHeatFluxAuxTempl : public AuxKernel
{
public:
  static InputParameters validParams();

  PorousFlowHeatFluxAuxTempl(const InputParameters & parameters);
...
typedef PorousFlowHeatFluxAuxTempl<true> ADPorousFlowHeatFluxAux;
