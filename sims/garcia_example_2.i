...
# ocean at y=0
#
# [failed] attempt to continue the result from archaea01d.i [run with a simple fluid for 10 kyr to reach ~equilibrium] but with tabulated EOS

[Mesh]
  construct_side_list_from_node_list=true
  [gen]
    type = FileMeshGenerator
    file = archaea01d_exodus.e
...
[Materials]
  ...
  []
   [fluid_eos]
    ...
    # minimum_pressure = 1                          # [failed] test for PorousFlowSingleComponentFluidTruncated
...
[Executioner]
  ...
  #end_time = 36000             # [s] 1000 year [i.e. run for another 4000 kyr]
