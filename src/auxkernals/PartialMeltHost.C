...
#include "PartialMeltHost.h"

registerMooseObject("dikesApp", PartialMeltHost);

InputParameters
PartialMeltHost::validParams()
{
...
PartialMeltHost::PartialMeltHost(const InputParameters & parameters)
 ...
 */
Real
PartialMeltHost::computeValue()
{
  return _temperature[_qp]* _value;
}
