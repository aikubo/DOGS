...
#include "TemperatureToEnthalpyConversionBC.h"
#include "Function.h"
...
registerMooseObject("dikesApp", TemperatureToEnthalpyConversionBC);

InputParameters
TemperatureToEnthalpyConversionBC::validParams()
{
  InputParameters params = DirichletBCBase::validParams();
  params.addRequiredParam<FunctionName>("function", "The forcing temperature function.");
  params.addClassDescription(
      "Imposes the boundary condition for a temperature function in the PorousFlow module using enthalpy as the main variable ");
...
TemperatureToEnthalpyConversionBC::TemperatureToEnthalpyConversionBC(const InputParameters & parameters)
...
Real
TemperatureToEnthalpyConversionBC::computeQpValue()
{
